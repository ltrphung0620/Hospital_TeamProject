          ...
          <div className="row">
            <div className="display-header">
              <h2 className="display-5 fw-bold text-dark">
                ...
                <span className="text-primary-500">(+487) 384 9452</span>
              </h2>
            </div>
            <form className="contact-form d-flex flex-wrap mt-5 gx-1">
              <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                <select
                  ...
                  name="choose"
                >
                  <option value="Select Your Department">Chọn Khoa</option>
                  <option value="Department">Khoa Vật Lý Trị Liệu</option>
                  <option value="Department">Khoa Nha Khoa</option>
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                ...
                >
                  ...
                  <option value="Naidan Smith">BS. Nguyễn Văn An</option>
                  <option value="Danial Frankie">BS. Trần Thị Bình</option>
                  <option value="Jason Roy">BS. Lê Văn Cường</option>
                </select>
              </div>
              <div className="col-lg-6 col-md-12 col-sm-12 mb-3">
                <input
